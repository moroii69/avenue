...
const GeneralDateModal = ({ isOpen, onClose, onDateChange, filteredEvents, startDate, endDate, setStartDate, setEndDate }) => {
            ...
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-xs">
                <div className="bg-[#151515] text-white p-4 rounded-xl w-[300px] shadow-xl">
                    ...
                    <div className="flex flex-col items-start mb-8">
                        <p className="text-gray-400 text-xs mt-1.5 font-inter">When do you want to start and end?</p>
                    </div>
...
export default GeneralDateModal;