                            ...
                            <div className="flex flex-col items-start justify-between w-full gap-4 md:flex-row">
                                <TabsList selectedValue={activeTab} className="md:bg-white/5 md:px-1 @4xl:rounded-full">
                                    ...
                                    >
                                        ...
                                        Past
                                        <span className="bg-[#151515] h-6 w-fit px-2 rounded-full flex items-center justify-center">
                                            {pastEvents.filter(event => event.explore === "YES" && event.status === 'active').length}
                                        </span>
                                    </TabTrigger>
                                    <TabTrigger
                                        value="drafts"
                                        ...
                                        <table className="w-full text-sm">
                                            ...
                                            <tbody>
                                                {filterEvents(pastEvents).length > 0 ? (
                                                    filterEvents(pastEvents).filter(event => event.explore === "YES" && event.status === 'active').map((event) => {
                                                        const totalTickets = (soldTickets[event._id] || 0) + (remainCount[event._id] || 0);
                                                        const soldPercentage = totalTickets > 0 ? (soldTickets[event._id] || 0) / totalTickets * 100 : 0;
                                                        return (
                                                            <tr
                    ...
                    <div className="flex flex-col gap-3 mt-3">
                        <button
                            onClick={async () => {
                                ...
                                try {
                                    const newStatus = selectedEvent.status === "active" ? "inactive" : "active";
