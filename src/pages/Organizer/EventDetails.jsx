...
export default function EventDetails() {
  ...
  const TABS = [
          ...
          <div className="rounded-xl border border-white/10 grid gap-6 p-4">
            ...
            <div className="flex items-center gap-x-3">
              ...
              <div className="bg-white/[0.06] h-8 p-2 px-2.5 w-fit rounded-full flex items-center justify-start gap-2">
                ...
                <span>Opens at {event.open_time}</span>
              </div>
            </div>
            <p className="tracking-wide leading-6" dangerouslySetInnerHTML={{ __html: event.event_description }}>
            </p>
          </div>
    ...
    },
    {
      ...
      content: <SalesTab eventId={event._id} />,
    },
    {
      id: "tickets",
      label: "Tickets",
