                                            ...
                                            <div className="flex flex-col items-center space-y-4 mt-5">
                                                <div className="flex space-x-3">
                                                    ...
                                                    <a
                                                        ...
                                                        onClick={(e) => { if (!organizer.instagram || organizer.instagram === 'undefined') e.preventDefault(); }}
                                                        className="card bg-primary border border-[#222222] text-white p-2 rounded-full shadow-lg flex items-center justify-center w-20 h-12"
                                                    >
                                                        <BsInstagram size={14} />
                                                    </a>
                                                    ...
                                                    <a
                                                        href={organizer.website && organizer.website !== 'undefined' ? organizer.website : '#'}
                                                        onClick={(e) => { if (!organizer.website || organizer.website === 'undefined') e.preventDefault(); }}
                                                        className="card bg-primary border border-[#222222] text-white p-2 rounded-full shadow-lg flex items-center justify-center w-20 h-12"
                                                    >
                                                        <Globe size={14} />
                                                    </a>
